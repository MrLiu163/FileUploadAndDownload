...
//		fileName = new String(fileName.getBytes("iso8859-1"),"UTF-8");
		...
		//通过文件名找出文件的所在目录
//		String path = findFileSavePathByFileName(fileName,fileSaveRootPath); // System.getProperty("file.separator")
...
//		File file = new File(path + System.getProperty("file.separator") + fileName);
		//如果文件不存在
		if(!file.exists()){
			request.setAttribute("message", "您要下载的资源已被删除！！路径为：" + newFilePath);
