 ...
 */
@WebServlet("/UploadHandleServletForApp")
public class UploadHandleServletForApp extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploadHandleServletForApp() {
        super();
			...
			//监听文件上传进度
			 ...
			 for(FileItem item : list){
				 ...
				 if(item.isFormField()){
					...
					//得到文件保存的名称
					 String saveFilename = FileHandleHelper.makeFileName(filename);
					 //得到文件的保存目录
					 String realSavePath = FileHandleHelper.makePath(saveFilename, savePath);
					 //创建一个文件输出流
